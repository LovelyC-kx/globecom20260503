...
constellation, \OrbitALIF{}-SNN drops by only $-0.126$\,dB
...
train the matched ANN backbone (\OrbitALIF{}-ANN, ReLU/BN drop-in)
...
\begin{figure}[!t]
  ...
  Blue: \OrbitALIF{}-SNN under \textsc{FedBN}+Gossip on the full
  constellation. Orange: matched-architecture \OrbitALIF{}-ANN
