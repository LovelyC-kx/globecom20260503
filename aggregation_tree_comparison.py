...
if __name__ == '__main__':
    ...
    #     num_satellites) + '_alpha_' + str(args.plane_alpha) + '_auxi_' + str(7) + '_TrainSetPartition.pkl', 'wb') as f:
    #     pickle.dump(local_dataset_indices, f)

    with open(home_dir + 'Outputs/EuroSat_SNN_planes_' + str(num_planes) + '_satellites_' + str(
            num_satellites) + '_alpha_' + str(args.plane_alpha) + '_auxi_' + str(7) + '_TrainSetPartition.pkl',
              'rb') as f:
