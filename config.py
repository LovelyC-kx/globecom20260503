...
parser.add_argument('--lr_decay_phase', default=5, type=int)
parser.add_argument('--lr_decay_ratio', default=0.9, type=float)
...
parser2.add_argument('--lr_decay_phase', default=5, type=int)
parser2.add_argument('--lr_decay_ratio', default=0.9, type=float)
...
parser2.add_argument('--plane_alpha', default=1, type=float)
